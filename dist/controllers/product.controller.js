import { createSuccessResponse, notFoundResponse, serverErrorResponse, successResponse } from "../utils/api.response.js";
...
export const registerProduct = async (req, res) => {
  try {
    ...
    await sequelize.query("EXEC usp_ins_product @name = :name, @description = :description, @price = :price", {
      replacements: {
        name,
        description,
        price
...
export const deleteProductById = async (req, res) => {
  try {
    ...
    return successResponse(`Product with ID ${productId} deleted successfully.`, null, res);
  } catch (ex) {
    return serverErrorResponse(ex, res);
  }
};
export const updateProductById = async (req, res) => {
  try {
    ...
    await sequelize.query("EXEC usp_upd_product @product_id = :id, @name = :name, @description = :description, @price = :price", {
      replacements: {
        id,
        name,
        description,
