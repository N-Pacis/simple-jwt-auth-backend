...
export async function executeStoredProcedures() {
  try {
    const dropProcedures = ["DROP PROCEDURE IF EXISTS usp_ins_product;", "DROP PROCEDURE IF EXISTS usp_get_product;", "DROP PROCEDURE IF EXISTS usp_list_product;", "DROP PROCEDURE IF EXISTS usp_upd_product;", "DROP PROCEDURE IF EXISTS usp_del_product;"];
